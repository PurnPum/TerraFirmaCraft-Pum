...
def generate(rm: ResourceManager):
    ...
    rm.item_tag('foods/usable_in_soup', '#tfc:foods/fruits', '#tfc:foods/vegetables', '#tfc:foods/meats', '#tfc:foods/cooked_meats', 'tfc:food/cooked_rice', 'tfc:food/boiled_egg')
    rm.item_tag('foods/usable_in_salad', '#tfc:foods/fruits', '#tfc:foods/vegetables', '#tfc:foods/cooked_meats', 'tfc:food/boiled_egg')
    rm.item_tag('foods/usable_in_sandwich', '#tfc:foods/vegetables', '#tfc:foods/cooked_meats', '#tfc:foods/dairy', 'tfc:food/cooked_egg')
    rm.item_tag('foods/usable_in_jam_sandwich', '#tfc:foods/dairy', '#tfc:foods/cooked_meats', '#tfc:foods/preserves', 'tfc:food/cooked_egg')
